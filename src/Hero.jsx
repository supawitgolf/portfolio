      ...
      <div className="hero-content column">
        ...
        <div className="hero-bottom">
          ...
          <div className="hero-buttons">
            <a href="https://drive.google.com/file/d/1TD8hNSxNLLpgGMEmkuieNsk8xFdXj-4i/view?usp=sharing" className="resume-btn" target="_blank" rel="noopener noreferrer">Resume</a>
